...
const EmojisStorage_1 = __importDefault(require("./utils/EmojisStorage"));
const AvatarUpdater_1 = __importDefault(require("./utils/AvatarUpdater"));
class Client extends discord_js_1.Client {
    constructor() {
        ...
        this.commands = new InteractionHandler_1.default('Commands');
        this.logger = new Logger_1.default();
        this.util = new Utils_1.default(this);
        this.emojisStorage = new EmojisStorage_1.default(this);
        this.avatarUpdater = new AvatarUpdater_1.default(this);
